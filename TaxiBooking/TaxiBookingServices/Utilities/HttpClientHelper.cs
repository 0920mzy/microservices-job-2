...
namespace TaxiBookingServices.Utilities
{
    public class HttpClientHelper
    {
        ...
        public static HttpClientHelper GetInstance()
        {
            ...
            else
            {
                ...
                httpClientHelper.httpClient.Timeout = new TimeSpan(0, 0, 15);
                return httpClientHelper;
            }
        }
        ...
        public HttpResponseMessage Post(string url, List<KeyValuePair<String, String>> paramList, List<KeyValuePair<string, string>> headers = null)
        {
            ...
            try
            {
                response = httpClient.PostAsync(new Uri(url), formUrlEncodedContent).Result;
            }
            catch (Exception ex)
            {
                response.StatusCode = System.Net.HttpStatusCode.ExpectationFailed;
